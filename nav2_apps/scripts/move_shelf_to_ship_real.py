...
class WarehouseNavigator(Node):
    def __init__(self):
        ...
        self.init_position = [-3.56, -1.05, 0.0]
        self.pre_loading_position = [0.75, -0.96, -1.4]
        self.loading_position = [0.90, -1.53, -1.4]
        self.post_loading_position = [0.58, -1.03, 3.14]
        self.pre_shipping_position = [-1.67, -1.03, 3.14]
        self.shipping_position = [-1.60, 0.33, 1.57]
        self.post_shipping_position = [-1.55, -0.98, -1.57]
    ...
    def main(self, args=None):
        ...
        if self.current_result:
            ...
            self.attach_shelf()
            self.update_robot_footprints(shape='square', radius=0.35)
