...
def generate_launch_description():
    ...
    rviz_config_dir = os.path.join(package_dir, 'rviz', 'rb1_rviz_real.rviz')
    approach_shelf_service_config = os.path.join(package_dir, 'config', 'approach_service_server_real.yaml')
